...
export const SESSION_COOKIE = isProd ? "__Host-cs_session" : "cs_session";
export const HANDSHAKE_COOKIE = isProd ? "__Host-cs_oauth" : "cs_oauth";
export const CSRF_COOKIE = isProd ? "__Host-cs_csrf" : "cs_csrf";
