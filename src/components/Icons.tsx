...
export const Share = ({ className = base }: Props) => (
...
/** A record with nothing to play: the play triangle, struck through. */
export const NoPreview = ({ className = base }: Props) => (
  <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    <circle cx="12" cy="12" r="9" />
...
/** Owned. Paired with green text, never used as the only signal. */
export const InCollection = ({ className = base }: Props) => (
